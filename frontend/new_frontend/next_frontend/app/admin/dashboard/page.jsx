  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <div className="grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <div className="glass-card" style={{ padding: '1.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div style={{ background: '#f1e3c6', padding: '0.75rem', borderRadius: '12px', color: 'white' }}>
              <Tags size={24} color="black"/>
            </div>
            <div>
      ...
      <div className="glass-card" style={{ padding: '1.5rem', marginTop: '2rem' }}>
        ...
        <div className="grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1rem' }}>
          <Link href="/admin/users" className="btn-primary" style={{ textDecoration: 'none', textAlign: 'center' }}>
            Manage Users
          </Link>
          <Link href="/admin/products" className="btn-primary" style={{ textDecoration: 'none', textAlign: 'center' }}>
            Manage Products
          </Link>
          <Link href="/admin/orders" className="btn-primary" style={{ textDecoration: 'none', textAlign: 'center' }}>
            View Orders
          </Link>
          <Link href="/admin/categories" className="btn-primary" style={{ textDecoration: 'none', textAlign: 'center' }}>
            Manage Categories
          </Link>
        </div>
      </div>
